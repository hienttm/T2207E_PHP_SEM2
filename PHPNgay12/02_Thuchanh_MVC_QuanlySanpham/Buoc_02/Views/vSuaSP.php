...
<form name="form1" method="post" action="ctlSanpham.php?act=xulysua">
  ...
  <table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td width="258"><input type="text" name="t1" id="t1"  value="<?=$tensach?>"></td>
    </tr>
    <tr>
      <td height="30">Tác giả:</td>
      <td><input type="text" name="t2" id="t2"  value="<?=$tacgia?>"></td>
    </tr>
    <tr>
      <td height="30">Giá:</td>
      <td><input type="text" name="t3" id="t3"  value="<?=$gia?>"></td>
    </tr>
    <tr>
